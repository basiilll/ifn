...
export const NOTIF_TEXT = {
  ...
  application_withdrawn: 'A response was withdrawn',
  application_deleted: 'A response was removed by an admin',
  service_response: 'New response on your Services post',
